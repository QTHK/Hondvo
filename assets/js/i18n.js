...
const I18N = {
  ...
  "hero_title": {"zh":"精密制造","en":"Precision Manufacturing","de":"Präzisionsfertigung","ru":"Прецизионное производство","fr":"Fabrication de précision","ja":"精密製造","ko":"정밀 제조","es":"Fabricación de precisión"},
  ...
  "hero_sub": {"zh":"敬畏生命","en":"Reverence for Life","de":"Ehrfurcht vor dem Leben","ru":"Благоговение перед жизнью","fr":"Révérence pour la vie","ja":"命への畏敬","ko":"생명에 대한 경외","es":"Reverencia por la vida"},

  "hero_desc":{"zh":"ISO 13485 / ISO 9001 / IATF 16949 认证","en":"ISO 13485 / ISO 9001 / IATF 16949 certified","de":"Zertifiziert nach ISO 13485 / ISO 9001 / IATF 16949","ru":"Сертифицировано по ISO 13485 / ISO 9001 / IATF 16949","fr":"Certifié ISO 13485 / ISO 9001 / IATF 16949","ja":"ISO 13485 / ISO 9001 / IATF 16949 認証取得","ko":"ISO 13485 / ISO 9001 / IATF 16949 인증","es":"Certificado ISO 13485 / ISO 9001 / IATF 16949"},
  ...
  "home_prod1_desc":{"zh":"为输液泵、注射器、胰岛素笔、肝素帽、肠内喂养等提供密封性、流动性和生物相容性俱佳的精密零件","en":"Precision components with excellent sealing, flow and biocompatibility for infusion pumps, syringes, insulin pens, heparin caps, enteral feeding and more","de":"Präzisionsteile mit hervorragender Dichtheit, Strömungsverhalten und Biokompatibilität für Infusionspumpen, Spritzen, Insulinpens, Heparinkappen, enterale Ernährung und mehr","ru":"Прецизионные детали с отличной герметичностью, текучестью и биосовместимостью для инфузионных насосов, шприцев, инсулиновых ручек, гепариновых колпачков, энтерального питания и др.","fr":"Pièces de précision à excellente étanchéité, fluidité et biocompatibilité pour pompes à perfusion, seringues, stylos à insuline, bouchons d'héparine, nutrition entérale, etc.","ja":"輸液ポンプ、注射器、インスリンペン、ヘパリンキャップ、経腸栄養などに、密封性・流動性・生体適合性に優れた精密部品を提供","ko":"수액 펌프, 주사기, 인슐린 펜, 헤파린 캡, 경장 영양 등에 밀봉성·유동성·생체적합성이 뛰어난 정밀 부품을 제공","es":"Componentes de precisión con excelente sellado, fluidez y biocompatibilidad para bombas de infusión, jeringas, bolígrafos de insulina, tapones de heparina, nutrición enteral y más"},

  "home_prod2_desc":{"zh":"为体外诊断（试管、标本杯、离心管、样本采集管、微孔板等）、影像设备（血糖分析仪、凝血分析仪等）提供高精度、高洁净度的热塑性和液态硅胶产品","en":"High-precision, high-cleanliness thermoplastic and liquid silicone products for IVD (test tubes, specimen cups, centrifuge tubes, sample collection tubes, microplates, etc.) and imaging devices (blood glucose analyzers, coagulation analyzers, etc.)","de":"Hochpräzise, hochreine Thermoplast- und Flüssigsilikonprodukte für IVD (Teströhrchen, Probenbecher, Zentrifugenröhrchen, Probenentnahmeröhrchen, Mikrotiterplatten usw.) und Bildgebungsgeräte (Blutzuckeranalysatoren, Gerinnungsanalysatoren usw.)","ru":"Высокоточные и высокочистые изделия из термопластов и жидкого силикона для IVD (пробирки, стаканчики для образцов, центрифужные пробирки, пробирки для забора образцов, микропланшеты и др.) и визуализационного оборудования (анализаторы глюкозы, коагулометры и др.)","fr":"Produits thermoplastiques et silicone liquide de haute précision et grande propreté pour le DIV (tubes à essai, godets à spécimen, tubes à centrifuger, tubes de prélèvement, microplaques, etc.) et les dispositifs d'imagerie (analyseurs de glycémie, analyseurs de coagulation, etc.)","ja":"体外診断（試験管、検体カップ、遠心管、検体採取管、マイクロプレートなど）および画像診断装置（血糖分析装置、凝固分析装置など）向けに、高精度・高清浄度の熱可塑性樹脂および液体シリコーン製品を提供","ko":"체외진단(시험관, 검체 컵, 원심분리관, 검체 채취관, 마이크로플레이트 등) 및 영상 장비(혈당 분석기, 응고 분석기 등)용 고정밀·고청정 열가소성 및 액상 실리콘 제품을 제공","es":"Productos termoplásticos y de silicona líquida de alta precisión y alta limpieza para DIV (tubos de ensayo, vasos de muestras, tubos de centrífuga, tubos de recogida de muestras, microplacas, etc.) y equipos de imagen (analizadores de glucosa, analizadores de coagulación, etc.)"},

  "home_prod3_desc":{"zh":"面向关键医疗应用的可靠模具制造商","en":"Your Reliable Tooling Manufacturer for Mission-Critical Medical Applications","de":"Ihr zuverlässiger Werkzeugbauer für kritische Medizinanwendungen","ru":"Ваш надёжный производитель пресс-форм для критически важных медицинских изделий","fr":"Votre fabricant de moules fiable pour applications médicales critiques","ja":"医療の重要用途に対応する信頼の金型メーカー","ko":"핵심 의료 응용 분야를 위한 신뢰할 수 있는 금형 제조사","es":"Su fabricante fiable de moldes para aplicaciones médicas críticas"},

  "home_prod4_title":{"zh":"呼吸系统","en":"Respiratory Systems","de":"Atemwegssysteme","ru":"Дыхательные системы","fr":"Systèmes respiratoires","ja":"呼吸器システム","ko":"호흡기 시스템","es":"Sistemas respiratorios"},

  "home_prod4_desc":{"zh":"为呼吸机（呼吸机涡轮壳体、呼吸机外壳、呼吸面罩、呼气阀、加湿器、过滤器、雾化器吸嘴（咬嘴）等）设备提供高可靠性、高安全性的核心零件","en":"High-reliability, high-safety core components for ventilators (turbine housings, ventilator housings, breathing masks, expiratory valves, humidifiers, filters, nebulizer mouthpieces, etc.)","de":"Hochzuverlässige und hochsichere Kernkomponenten für Beatmungsgeräte (Turbinengehäuse, Gehäuse, Atemmasken, Ausatemventile, Befeuchter, Filter, Verneblermundstücke usw.)","ru":"Высоконадежные и высокобезопасные ключевые компоненты для аппаратов ИВЛ (корпуса турбин, корпуса ИВЛ, дыхательные маски, клапаны выдоха, увлажнители, фильтры, мундштуки небулайзеров и др.)","fr":"Composants essentiels à haute fiabilité et haute sécurité pour ventilateurs (carters de turbine, boîtiers, masques respiratoires, valves expiratoires, humidificateurs, filtres, embouts de nébuliseur, etc.)","ja":"人工呼吸器（タービンハウジング、ベンチレーター筐体、呼吸マスク、呼気弁、加湿器、フィルター、ネブライザーのマウスピースなど）向けに、高信頼性・高安全性のコア部品を提供","ko":"인공호흡기(터빈 하우징, 인공호흡기 케이싱, 호흡 마스크, 호기 밸브, 가습기, 필터, 네뷸라이저 마우스피스 등)용 고신뢰성·고안전성 핵심 부품을 제공","es":"Componentes esenciales de alta fiabilidad y alta seguridad para ventiladores (carcasas de turbina, carcasas de ventilador, mascarillas respiratorias, válvulas espiratorias, humidificadores, filtros, boquillas de nebulizador, etc.)"},

  "home_prod5_title":{"zh":"食品/医疗包装 & 母婴类产品","en":"Food / Medical Packaging & Baby & Maternal Products","de":"Lebensmittel-/Medizinverpackung & Baby- und Mutterprodukte","ru":"Упаковка для пищевой/медицинской продукции и товары для мам и малышей","fr":"Emballage alimentaire/médical & produits bébé et maternité","ja":"食品・医療包装 & ベビー・マタニティ製品","ko":"식품/의료 포장 & 유아·출산 용품","es":"Envases alimentarios/médicos y productos para bebés y maternidad"},

  "home_prod5_desc":{"zh":"强调无毒无味、食品级/医疗级 FDA 认证、极佳的亲肤触感与高重复使用耐久度","en":"Non-toxic and odorless, food-grade/medical-grade FDA certified, with excellent skin-friendly touch and high reusability durability","de":"Ungiftig und geruchlos, FDA-zertifiziert in Lebensmittel-/Medizinqualität, mit hervorragender hautfreundlicher Haptik und hoher Wiederverwendbarkeit","ru":"Нетоксичные и без запаха, сертифицированные FDA материалы пищевого/медицинского класса, превосходная тактильная дружелюбность к коже и высокая износостойкость при многократном использовании","fr":"Non toxiques et inodores, certifiés FDA qualité alimentaire/médicale, avec un excellent toucher respectueux de la peau et une grande durabilité réutilisable","ja":"無毒・無臭、食品グレード/医療グレードのFDA認証、優れた肌触りと高い繰り返し使用耐久性を実現","ko":"무독·무취, 식품 등급/의료 등급 FDA 인증, 뛰어난 피부 친화 촉감과 높은 반복 사용 내구성","es":"No tóxicos e inodoros, certificados FDA de grado alimentario/médico, con un excelente tacto respetuoso con la piel y alta durabilidad reutilizable"},



  "home_more":{"zh":"了解详情","en":"Learn More","de":"Mehr erfahren","ru":"Подробнее","fr":"En savoir plus","ja":"詳細を見る","ko":"자세히 보기","es":"Más información"},
"home_prod3_more":{"zh":"制造能力","en":"Manufacturing Capabilities","de":"Fertigungskapazitäten","ru":"Производственные возможности","fr":"Capacités de fabrication","ja":"製造能力","ko":"제조 역량","es":"Capacidades de fabricación"},
"hero_tag": {"zh":"精密医疗模具制造","en":"Precision Medical Mold Manufacturing","de":"Präzisions-Werkzeugbau für Medizintechnik","ru":"Прецизионное производство медицинских пресс-форм","fr":"Fabrication de moules médicaux de précision","ja":"精密医療用金型製造","ko":"정밀 의료용 금형 제조","es":"Fabricación de moldes médicos de precisión"},
"home_sectors_title":{"zh":"应用领域","en":"Application Areas","de":"Anwendungsbereiche","ru":"Области применения","fr":"Domaines d'application","ja":"応用分野","ko":"응용 분야","es":"Áreas de aplicación"},
...
"home_sec_1_t":{"zh":"静脉治疗与营养支持","en":"IV Therapy & Nutrition Support","de":"Infusionstherapie & Ernährung","ru":"Инфузионная терапия и питание","fr":"Thérapie IV et nutrition","ja":"輸液治療と栄養サポート","ko":"정맥 치료 및 영양 지원","es":"Terapia intravenosa y nutrición"},
"home_sec_1_l1":{"zh":"微米级精度（±0.005mm）","en":"Micron-level precision (±0.005 mm)","de":"Mikrongenaue Präzision (±0,005 mm)","ru":"Микронная точность (±0,005 мм)","fr":"Précision micrométrique (±0,005 mm)","ja":"ミクロン級精度（±0.005mm）","ko":"미크론급 정밀도(±0.005mm)","es":"Precisión micrométrica (±0,005 mm)"},
"home_sec_1_l2":{"zh":"医疗级 PP / PS 等（生物相容性）","en":"Medical-grade PP / PS (biocompatible)","de":"Medizinische PP / PS (biokompatibel)","ru":"Медицинские PP / PS (биосовместимые)","fr":"PP / PS de qualité médicale (biocompatibles)","ja":"医療グレード PP / PS など（生体適合性）","ko":"의료 등급 PP / PS 등(생체 적합성)","es":"PP / PS de grado médico (biocompatibles)"},
"home_sec_1_l3":{"zh":"无死角设计（避免残留）","en":"Dead-zone-free design (no residue)","de":"TOTRAUMFREIES Design (keine Rückstände)","ru":"Конструкция без застойных зон (без остатка)","fr":"Conception sans zone morte (sans résidu)","ja":"デッドスペースレス設計（残留防止）","ko":"데드존 없는 설계(잔류 방지)","es":"Diseño sin zonas muertas (sin residuos)"},
"home_sec_1_l4":{"zh":"高洁净度生产（无颗粒污染）","en":"High-cleanliness production (particle-free)","de":"Hochreine Fertigung (partikelfrei)","ru":"Высокочистое производство (без частиц)","fr":"Production à haute propreté (sans particules)","ja":"高クリーン度生産（パーティクル汚染なし）","ko":"고청정 생산(입자 오염 없음)","es":"Producción de alta limpieza (sin partículas)"},
"home_sec_2_t":{"zh":"检验医学与样本处理","en":"Clinical Diagnostics & Sample Handling","de":"Labordiagnostik & Probenhandling","ru":"Лабораторная диагностика и работа с образцами","fr":"Diagnostic clinique et traitement des échantillons","ja":"臨床検査と検体処理","ko":"임상 진단 및 검체 처리","es":"Diagnóstico clínico y manejo de muestras"},
"home_sec_2_l1":{"zh":"微米级精度（±0.005mm）","en":"Micron-level precision (±0.005 mm)","de":"Mikrongenaue Präzision (±0,005 mm)","ru":"Микронная точность (±0,005 мм)","fr":"Précision micrométrique (±0,005 mm)","ja":"ミクロン級精度（±0.005mm）","ko":"미크론급 정밀도(±0.005mm)","es":"Precisión micrométrica (±0,005 mm)"},
"home_sec_2_l2":{"zh":"医疗级 PP / PS 等（生物相容性）","en":"Medical-grade PP / PS (biocompatible)","de":"Medizinische PP / PS (biokompatibel)","ru":"Медицинские PP / PS (биосовместимые)","fr":"PP / PS de qualité médicale (biocompatibles)","ja":"医療グレード PP / PS など（生体適合性）","ko":"의료 등급 PP / PS 등(생체 적합성)","es":"PP / PS de grado médico (biocompatibles)"},
"home_sec_2_l3":{"zh":"多穴模具","en":"Multi-cavity molds","de":"Mehrfachformen","ru":"Многогнёздные пресс-формы","fr":"Moules multi-empreintes","ja":"多キャビティ金型","ko":"다중 캐비티 금형","es":"Moldes multicavidad"},
"home_sec_2_l4":{"zh":"Cycle time 优化","en":"Cycle time optimization","de":"Zykluszeit-Optimierung","ru":"Оптимизация цикла","fr":"Optimisation du temps de cycle","ja":"サイクルタイム最適化","ko":"사이클 타임 최적화","es":"Optimización del tiempo de ciclo"},
"home_sec_2_l5":{"zh":"长期稳定的生产","en":"Long-term stable production","de":"Langfristig stabile Produktion","ru":"Долгосрочно стабильное производство","fr":"Production stable à long terme","ja":"長期的に安定した生産","ko":"장기적으로 안정적인 생산","es":"Producción estable a largo plazo"},
"home_sec_3_t":{"zh":"呼吸治疗与通气支持","en":"Respiratory Therapy & Ventilation","de":"Atemtherapie & Beatmung","ru":"Респираторная терапия и вентиляция","fr":"Thérapie respiratoire et ventilation","ja":"呼吸療法と人工呼吸","ko":"호흡 치료 및 환기 지원","es":"Terapia respiratoria y ventilación"},
"home_sec_3_l1":{"zh":"微米级精度（±0.005mm）","en":"Micron-level precision (±0.005 mm)","de":"Mikrongenaue Präzision (±0,005 mm)","ru":"Микронная точность (±0,005 мм)","fr":"Précision micrométrique (±0,005 mm)","ja":"ミクロン級精度（±0.005mm）","ko":"미크론급 정밀도(±0.005mm)","es":"Precisión micrométrica (±0,005 mm)"},
"home_sec_3_l2":{"zh":"医疗级 PP / PS 等（生物相容性）","en":"Medical-grade PP / PS (biocompatible)","de":"Medizinische PP / PS (biokompatibel)","ru":"Медицинские PP / PS (биосовместимые)","fr":"PP / PS de qualité médicale (biocompatibles)","ja":"医療グレード PP / PS など（生体適合性）","ko":"의료 등급 PP / PS 등(생체 적합성)","es":"PP / PS de grado médico (biocompatibles)"},
"home_sec_3_l3":{"zh":"阻燃材料成型（UL94 V-0）","en":"Flame-retardant molding (UL94 V-0)","de":"Formgebung flammhemmender Materialien (UL94 V-0)","ru":"Формование огнестойких материалов (UL94 V-0)","fr":"Moulage de matériaux ignifuges (UL94 V-0)","ja":"難燃材料成形（UL94 V-0）","ko":"난연 소재 성형(UL94 V-0)","es":"Moldeo de materiales ignífugos (UL94 V-0)"},
"home_sec_3_l4":{"zh":"抗菌材料应用（ISO 22196）","en":"Antimicrobial materials (ISO 22196)","de":"Antimikrobielle Materialien (ISO 22196)","ru":"Антимикробные материалы (ISO 22196)","fr":"Matériaux antimicrobiens (ISO 22196)","ja":"抗菌材料の適用（ISO 22196）","ko":"항균 소재 적용(ISO 22196)","es":"Materiales antimicrobianos (ISO 22196)"},
"home_sec_3_l5":{"zh":"多穴模","en":"Multi-cavity molds","de":"Mehrfachformen","ru":"Многогнёздные пресс-формы","fr":"Moules multi-empreintes","ja":"多キャビティ金型","ko":"다중 캐비티 금형","es":"Moldes multicavidad"},
"home_sec_3_l6":{"zh":"无尘车间生产","en":"Cleanroom production","de":"Reinraumfertigung","ru":"Производство в чистых помещениях","fr":"Production en salle blanche","ja":"クリーンルーム生産","ko":"클린룸 생산","es":"Producción en sala limpia"},
"home_sec_4_t":{"zh":"母婴护理与食品接触","en":"Maternal Care & Food Contact","de":"Mutterpflege & Lebensmittelkontakt","ru":"Уход за матерью и контакт с пищей","fr":"Soins maternels et contact alimentaire","ja":"マタニティケアと食品接触","ko":"모성 케어 및 식품 접촉","es":"Cuidado materno y contacto alimentario"},
"home_sec_4_l1":{"zh":"母婴护理与妇科医疗","en":"Maternal & gynecological care","de":"Mutterpflege und Gynäkologie","ru":"Уход за матерью и гинекология","fr":"Soins maternels et gynécologiques","ja":"マタニティケア・婦人科医療","ko":"모성 케어 및 부인과 의료","es":"Cuidado materno y ginecología"},
"home_sec_4_l2":{"zh":"可穿戴医疗与监测设备","en":"Wearable medical & monitoring devices","de":"Wearable-Medizin- und Überwachungsgeräte","ru":"Носимые медицинские устройства и мониторинг","fr":"Dispositifs médicaux portables et de surveillance","ja":"ウェアラブル医療・モニタリング機器","ko":"웨어러블 의료 및 모니터링 기기","es":"Dispositivos médicos portátiles y de monitorización"},
"home_sec_4_l3":{"zh":"安全药瓶","en":"Safety medicine bottles","de":"Sicherheitsmedizinflaschen","ru":"Безопасные флаконы для лекарств","fr":"Flacons de médicaments sécurisés","ja":"安全薬瓶","ko":"안전 약병","es":"Frascos de medicamentos seguros"},
"home_sec_4_l4":{"zh":"分药盒","en":"Pill organizers","de":"Tablettendosen","ru":"Таблетницы","fr":"Piluliers","ja":"ピルケース","ko":"약통·알약 케이스","es":"Pastilleros"},

"prod1_tag1":{"zh":"输液泵","en":"Infusion pumps","de":"Infusionspumpen","ru":"Инфузионные насосы","fr":"Pompes à perfusion","ja":"輸液ポンプ","ko":"주입 펌프","es":"Bombas de infusión"},
"prod1_tag2":{"zh":"注射器","en":"Syringes","de":"Spritzen","ru":"Шприцы","fr":"Seringues","ja":"注射器","ko":"주사기","es":"Jeringas"},
"prod1_tag3":{"zh":"胰岛素笔","en":"Insulin pens","de":"Insulinpens","ru":"Инсулиновые ручки","fr":"Stylos à insuline","ja":"インスリンペン","ko":"인슐린 펜","es":"Plumas de insulina"},
"prod1_tag4":{"zh":"肠内喂养","en":"Enteral feeding","de":"Enterale Ernährung","ru":"Энтеральное питание","fr":"Nutrition entérale","ja":"経腸栄養","ko":"경장 영양","es":"Nutrición enteral"},
"prod2_tag1":{"zh":"试管","en":"Test tubes","de":"Teströhrchen","ru":"Пробирки","fr":"Tubes à essai","ja":"試験管","ko":"시험관","es":"Tubos de ensayo"},
"prod2_tag2":{"zh":"标本杯","en":"Specimen cups","de":"Probenbecher","ru":"Стаканчики для образцов","fr":"Gobelets à échantillons","ja":"検体カップ","ko":"검체 컵","es":"Vasos para muestras"},
"prod2_tag3":{"zh":"微孔板","en":"Microplates","de":"Mikrotiterplatten","ru":"Микропланшеты","fr":"Microplaques","ja":"マイクロプレート","ko":"마이크로플레이트","es":"Microplacas"},
"prod2_tag4":{"zh":"采样管","en":"Collection tubes","de":"Entnahmeröhrchen","ru":"Пробирки для забора","fr":"Tubes de prélèvement","ja":"採血管","ko":"채취관","es":"Tubos de recogida"},
"prod3_tag1":{"zh":"23 台 CNC","en":"23 CNC","de":"23 CNC","ru":"23 ЧПУ","fr":"23 CNC","ja":"CNC 23 台","ko":"CNC 23대","es":"23 CNC"},
"prod3_tag2":{"zh":"8 台 EDM","en":"8 EDM","de":"8 EDM","ru":"8 EDM","fr":"8 EDM","ja":"EDM 8 台","ko":"EDM 8대","es":"8 EDM"},
"prod3_tag3":{"zh":"7 台线切割","en":"7 Wire-cut","de":"7 Drahterosion","ru":"7 электроэрозионных","fr":"7 découpe fil","ja":"ワイヤカット 7 台","ko":"와이어컷 7대","es":"7 corte por hilo"},
"prod3_tag4":{"zh":"顶级设备矩阵","en":"Top-tier equipment","de":"Spitzentechnik","ru":"Оборудование топ-класса","fr":"Équipement haut de gamme","ja":"トップ設備","ko":"최상급 장비","es":"Equipos de primer nivel"},
"prod4_tag1":{"zh":"呼吸机壳体","en":"Ventilator housings","de":"Beatmungsgerätegehäuse","ru":"Корпуса аппаратов ИВЛ","fr":"Boîtiers de ventilateurs","ja":"人工呼吸器筐体","ko":"인공호흡기 하우징","es":"Carcasas de ventiladores"},
"prod4_tag2":{"zh":"呼吸面罩","en":"Breathing masks","de":"Atemmasken","ru":"Дыхательные маски","fr":"Masques respiratoires","ja":"呼吸マスク","ko":"호흡 마스크","es":"Mascarillas respiratorias"},
"prod4_tag3":{"zh":"呼气阀","en":"Expiratory valves","de":"Ausatemventile","ru":"Выдыхательные клапаны","fr":"Valves expiratoires","ja":"呼気弁","ko":"호기 밸브","es":"Válvulas espiratorias"},
"prod4_tag4":{"zh":"雾化器吸嘴","en":"Nebulizer mouthpieces","de":"Verneblermundstücke","ru":"Мундштуки небулайзеров","fr":"Embouts de nébuliseur","ja":"ネブライザーマウスピース","ko":"네뷸라이저 마우스피스","es":"Boquillas de nebulizador"},
"prod5_tag1":{"zh":"无毒无味","en":"Non-toxic, odorless","de":"Ungiftig, geruchlos","ru":"Нетоксичные, без запаха","fr":"Non toxiques, inodores","ja":"無毒・無臭","ko":"무독·무취","es":"No tóxicos, inodoros"},
"prod5_tag2":{"zh":"食品级 FDA","en":"Food-grade FDA","de":"FDA-Lebensmittelqualität","ru":"Пищевой FDA","fr":"FDA alimentaire","ja":"食品グレード FDA","ko":"식품 등급 FDA","es":"FDA grado alimentario"},
"prod5_tag3":{"zh":"亲肤触感","en":"Skin-friendly touch","de":"Hautfreundliche Haptik","ru":"Дружелюбная к коже","fr":"Toucher doux pour la peau","ja":"肌に優しい触感","ko":"피부 친화적 촉감","es":"Tacto suave con la piel"},
"prod5_tag4":{"zh":"高耐久复用","en":"Highly reusable","de":"Mehrfach nutzbar","ru":"Многоразовые","fr":"Haute réutilisabilité","ja":"高い再使用耐久性","ko":"높은 반복 사용 내구성","es":"Muy reutilizables"},

"home_sec_1_scene":{"zh":"静脉输液、肠内营养与自我给药等治疗环节，对密封性、流量一致性与生物相容性要求严苛","en":"Clinical settings such as IV infusion, enteral nutrition and self-administration, where sealing, flow consistency and biocompatibility are critical","de":"Klinische Anwendungen wie Infusion, enterale Ernährung und Selbstmedikation, bei denen Dichtheit, Durchflusskonstanz und Biokompatibilität entscheidend sind","ru":"Клинические сценарии — инфузия, энтеральное питание, самостоятельное введение, где критичны герметичность, постоянство потока и биосовместимость","fr":"Contextes cliniques tels que la perfusion, la nutrition entérale et l'auto-administration, où étanchéité, régularité du débit et biocompatibilité sont critiques","ja":"輸液・経腸栄養・自己投与などの臨床場面。密封性、流量の安定性、生体適合性が重視されます","ko":"수액 주입, 경장 영양, 자가 투여 등 임상 현장으로, 밀봉성·유량 일관성·생체 적합성이 중요합니다","es":"Entornos clínicos como la infusión, la nutrición enteral y la autoadministración, donde la estanqueidad, la constancia del flujo y la biocompatibilidad son críticas"},
"home_sec_2_scene":{"zh":"样本采集、保存与检测分析全流程，要求高洁净度、低吸附与尺寸一致性","en":"The full chain of sample collection, storage and analysis, requiring high cleanliness, low adsorption and dimensional consistency","de":"Die gesamte Kette von Probenentnahme, Lagerung und Analyse — hohe Reinheit, geringe Adsorption und Maßhaltigkeit gefordert","ru":"Весь цикл — забор, хранение и анализ образцов, с требованиями к чистоте, низкой адсорбции и точности размеров","fr":"Toute la chaîne de prélèvement, conservation et analyse, exigeant une grande propreté, une faible adsorption et une constance dimensionnelle","ja":"検体の採取・保存・分析の全工程。高い清浄度、低吸着、寸法安定性が求められます","ko":"검체 채취·보관·분석 전 과정으로, 높은 청정도와 낮은 흡착, 치수 일관성이 요구됩니다","es":"Toda la cadena de toma, conservación y análisis de muestras, con exigentes requisitos de limpieza, baja adsorción y constancia dimensional"},
"home_sec_3_scene":{"zh":"机械通气、氧疗与雾化治疗等呼吸支持环节，对气密性与长期可靠性要求极高","en":"Respiratory support such as mechanical ventilation, oxygen therapy and nebulization, with stringent airtightness and long-term reliability","de":"Beatmung, Sauerstofftherapie und Verneblung — höchste Anforderungen an Dichtheit und Langzeitzuverlässigkeit","ru":"ИВЛ, кислородотерапия и небулайзерная терапия — повышенные требования к герметичности и долговременной надёжности","fr":"Ventilation mécanique, oxygénothérapie et nébulisation, avec des exigences élevées d'étanchéité et de fiabilité à long terme","ja":"人工呼吸、酸素療法、ネブライザー治療などの呼吸支援。気密性と長期信頼性が特に重視されます","ko":"기계 환기, 산소 요법, 네뷸라이저 치료 등 호흡 지원 분야로, 기밀성과 장기 신뢰성이 매우 중요합니다","es":"Ventilación mecánica, oxigenoterapia y nebulización, con altas exigencias de estanqueidad y fiabilidad a largo plazo"},
"home_sec_4_scene":{"zh":"母婴护理、喂养与食品接触类日常使用，要求无毒无味、食品级合规与亲肤耐用","en":"Daily use in maternal care, feeding and food-contact applications, requiring non-toxicity, food-grade compliance and skin-friendly durability","de":"Mutterpflege, Fütterung und Lebensmittelkontakt im Alltag — ungiftig, lebensmittelkonform und hautfreundlich haltbar","ru":"Уход за матерью, кормление и контакт с пищей в повседневном использовании — нетоксичность, пищевое соответствие, стойкость","fr":"Soins maternels, alimentation et contact alimentaire au quotidien, exigeant non-toxicité, conformité alimentaire et durabilité douce pour la peau","ja":"マタニティケア、授乳・食事、食品接触など日常使用。無毒・無臭、食品グレード適合、肌に優しい耐久性が求められます","ko":"모성 케어, 수유, 식품 접촉 등 일상 사용으로, 무독·무취, 식품 등급 적합성, 피부 친화적 내구성이 요구됩니다","es":"Cuidado materno, alimentación y contacto alimentario de uso diario, con requisitos de no toxicidad, conformidad alimentaria y durabilidad suave con la piel"},
...
"home_news_more":{"zh":"查看全部新闻 →","en":"View All News →","de":"Alle Nachrichten →","ru":"Все новости →","fr":"Toutes les actualités →","ja":"すべてのニュース →","ko":"모든 뉴스 보기 →","es":"Ver todas las noticias →"},
  ...
  "prod_hero_sub":{"zh":"欧美 OEM 级医疗制造背书 · ISO 13485 / FDA / Class 8","en":"Trusted by EU & US OEMs · ISO 13485 / FDA / Class 8","de":"Vertrauen von EU- und US-OEMs · ISO 13485 / FDA / Class 8","ru":"Доверие OEM-производителей ЕС и США · ISO 13485 / FDA / Class 8","fr":"Partenaire des OEM européens et américains · ISO 13485 / FDA / Class 8","ja":"欧米OEMの医療製造パートナー · ISO 13485 / FDA / Class 8","ko":"유럽·미국 OEM의 의료 제조 파트너 · ISO 13485 / FDA / Class 8","es":"Socio de fabricación médica de OEM europeos y estadounidenses · ISO 13485 / FDA / Class 8"},
  ...
  "ph_b_iso13485":{"zh":"ISO 13485","en":"ISO 13485","de":"ISO 13485","ru":"ISO 13485","fr":"ISO 13485","ja":"ISO 13485","ko":"ISO 13485","es":"ISO 13485"},
  "ph_b_iso13485_s":{"zh":"医疗质量体系认证","en":"Medical Quality Management Certification","de":"Zertifizierung Medizin-QMS","ru":"Сертификация СМК для медизделий","fr":"Certification SMQ médical","ja":"医療品質マネジメント認証","ko":"의료 품질경영 인증","es":"Certificación de gestión de calidad médica"},
  "ph_b_fda":{"zh":"FDA 合规","en":"FDA Compliant","de":"FDA-konform","ru":"Соответствие FDA","fr":"Conforme FDA","ja":"FDA準拠","ko":"FDA 준수","es":"Conforme a FDA"},
  "ph_b_fda_s":{"zh":"100% 医疗级 / 食品级材料","en":"100% Medical / Food-grade Materials","de":"100 % Materialien in Medizin-/Lebensmittelqualität","ru":"100 % материалов медицинского/пищевого класса","fr":"100 % de matériaux médicaux / alimentaires","ja":"100% 医療・食品グレード材料","ko":"100% 의료·식품 등급 소재","es":"100 % materiales de grado médico / alimentario"},
  "ph_b_precision":{"zh":"0.5 μm 精度","en":"0.5 μm Precision","de":"0,5 μm Präzision","ru":"Точность 0,5 мкм","fr":"Précision 0,5 μm","ja":"0.5 μm 精密加工","ko":"0.5 μm 정밀도","es":"Precisión de 0,5 μm"},
  "ph_b_precision_s":{"zh":"超精密模具加工","en":"Ultra-precision Mold Machining","de":"Hochpräzise Formenbearbeitung","ru":"Сверхточная обработка пресс-форм","fr":"Usinage de moules ultra-précis","ja":"超精密金型加工","ko":"초정밀 금형 가공","es":"Mecanizado de moldes de ultra precisión"},
  "ph_b_clean":{"zh":"Class 8 十万级洁净室","en":"Class 8 Cleanroom","de":"Class 8 Reinraum","ru":"Чистое помещение класса 8","fr":"Salle blanche classe 8","ja":"クラス8 クリーンルーム","ko":"클래스 8 클린룸","es":"Sala blanca clase 8"},
  "ph_b_clean_s":{"zh":"十万级洁净室生产","en":"Class 100,000 Cleanroom Production","de":"Produktion im Reinraum Klasse 100.000","ru":"Производство в чистом помещении класса 100 000","fr":"Production en salle blanche classe 100 000","ja":"クラス100,000クリーンルーム生産","ko":"클래스 100,000 클린룸 생산","es":"Producción en sala blanca clase 100.000"},
  ...
  "prod1_title":{"zh":"输液与给药系统","en":"Infusion and Drug Delivery Systems","de":"Infusions- und Arzneimittelabgabesysteme","ru":"Системы инфузии и доставки лекарств","fr":"Systèmes de perfusion et d'administration de médicaments","ja":"輸液・薬液投与システム","ko":"수액 및 약물 전달 시스템","es":"Sistemas de infusión y administración de fármacos"},

  "prod2_title":{"zh":"体外诊断与采样（IVD）","en":"In Vitro Diagnostics & Sampling (IVD)","de":"In-vitro-Diagnostik & Probenahme (IVD)","ru":"Инвитро-диагностика и взятие проб (IVD)","fr":"Diagnostic in vitro & prélèvement (IVD)","ja":"体外診断・検体採取（IVD）","ko":"체외진단 및 검체 채취 (IVD)","es":"Diagnóstico in vitro y toma de muestras (IVD)"},

  "prod3_title":{"zh":"超精密医疗级注塑与 LSR 模具","en":"Ultra-Precision Medical-Grade Injection & LSR Molds","de":"Ultrapräzise medizinische Spritzguss- und LSR-Formen","ru":"Ультрапрецизионные медицинские пресс-формы для литья и LSR","fr":"Moules d'injection et LSR médicaux ultra-précision","ja":"超精密医療グレード 射出・LSR金型","ko":"초정밀 의료용 사출·LSR 금형","es":"Moldes de inyección y LSR médicos de ultra precisión"},
  ...
  "mold_hero":{"zh":"高端医疗注塑模具 | 精密与合规双重保障","en":"Premium Medical Injection Molds | Precision & Compliance Guaranteed","de":"Premium-Spritzgießformen für die Medizin | Präzision und Konformität garantiert","ru":"Премиальные медицинские литьевые пресс-формы | Гарантия точности и соответствия","fr":"Moules d'injection médicaux haut de gamme | Précision et conformité garanties","ja":"プレミアム医療用射出成形金型｜精密性と適合性を保証","ko":"프리미엄 의료용 사출 금형 | 정밀성과 규정 준수 보장","es":"Moldes de inyección médicos premium | Precisión y cumplimiento garantizados"},

  "mold_hero_sub":{"zh":"我们专注于生命科学与医疗器械行业的高精密医疗注塑模具制造。遵循严格的医疗级标准，交付无污染、高公差、完全合规的模具解决方案，支撑医疗塑料零件的可靠量产。","en":"We specialize in high-precision medical injection mold manufacturing for life science and medical device industries. Adhering to strict medical-grade standards, we deliver contamination-free, high-tolerance, and fully compliant mold solutions to support reliable mass production of medical plastic components.","de":"Wir sind auf die Herstellung hochpräziser medizinischer Spritzgießformen für die Life-Science- und Medizintechnikindustrie spezialisiert. Nach strengen Medizinstandards liefern wir kontaminationsfreie, hochtolerante und vollständig konforme Formenlösungen für die zuverlässige Serienfertigung medizinischer Kunststoffkomponenten.","ru":"Мы специализируемся на производстве высокоточных медицинских литьевых пресс-форм для отраслей наук о жизни и медицинских изделий. Следуя строгим медицинским стандартам, мы поставляем не содержащие загрязнений, высокоточные и полностью соответствующие требованиям решения для надёжного серийного производства медицинских пластиковых компонентов.","fr":"Nous sommes spécialisés dans la fabrication de moules d'injection médicaux de haute précision pour les industries des sciences de la vie et des dispositifs médicaux. En respectant des normes médicales strictes, nous livrons des solutions de moules sans contamination, à haute tolérance et entièrement conformes pour soutenir la production en série fiable de composants plastiques médicaux.","ja":"当社は、ライフサイエンスおよび医療機器業界向けの高精度医療用射出成形金型製造を専門としています。厳格な医療グレード基準に従い、汚染のない、高公差で完全適合の金型ソリューションを提供し、医療用プラスチック部品の信頼性の高い量産を支えます。","ko":"당사는 생명과학 및 의료기기 산업을 위한 고정밀 의료용 사출 금형 제조를 전문으로 합니다. 엄격한 의료 등급 표준을 준수하여 오염 없는 고공차, 완전 규정 준수 금형 솔루션을 제공하며 의료용 플라스틱 부품의 안정적인 양산을 지원합니다.","es":"Estamos especializados en la fabricación de moldes de inyección médicos de alta precisión para las industrias de ciencias de la vida y dispositivos médicos. Cumpliendo estrictos estándares de grado médico, entregamos soluciones de moldes libres de contaminación, de alta tolerancia y totalmente conformes para respaldar la producción en serie fiable de componentes plásticos médicos."},
/* ── 2026-09-22 补齐「孤儿 key」：以下 16 个 key 此前只在 HTML 内写死中文、i18n 字典中缺失，
   导致 switchLang 遍历时直接跳过 → 永远显示中文。现补入 8 语言定义，使其参与语言切换。 ── */
"mold_hero_eyebrow":{"zh":"医疗器械精密制造","en":"Precision Medical Manufacturing","de":"Präzisionsfertigung für Medizintechnik","ru":"Прецизионное медицинское производство","fr":"Fabrication médicale de précision","ja":"医療機器の精密製造","ko":"정밀 의료기기 제조","es":"Fabricación médica de precisión"},
"mold_cap_kicker":{"zh":"模具能力","en":"Mold Capabilities","de":"Werkzeugbau-Fähigkeiten","ru":"Возможности пресс-форм","fr":"Capacités de moulage","ja":"金型能力","ko":"금형 역량","es":"Capacidades de moldes"},
"mold_cap_title":{"zh":"聚焦医疗器械的模具","en":"Molds Focused on Medical Devices","de":"Formen für Medizinprodukte","ru":"Пресс-формы для медицинских изделий","fr":"Moules dédiés aux dispositifs médicaux","ja":"医療機器に特化した金型","ko":"의료기기에 집중한 금형","es":"Moldes enfocados a dispositivos médicos"},
"mold_cap_sub":{"zh":"点击展开看模具实拍 · 悬停放大 · 点击轮播大图","en":"Click to expand mold photos · Hover to zoom · Click to browse the gallery","de":"Klicken zum Aufklappen der Formenfotos · Hover zum Vergrößern · Klicken für die Galerie","ru":"Нажмите, чтобы раскрыть фото пресс-форм · Наведение для увеличения · Клик для галереи","fr":"Cliquez pour déplier les photos de moules · Survolez pour agrandir · Cliquez pour la galerie","ja":"クリックで金型実写を展開・ホバーで拡大・クリックでギャラリー","ko":"클릭하여 금형 실사 펼치기 · 호버로 확대 · 클릭으로 갤러리","es":"Clic para expandir fotos de moldes · Pasar para ampliar · Clic para la galería"},
"mold_flow_kicker":{"zh":"制造工艺","en":"Manufacturing Process","de":"Fertigungsprozess","ru":"Процесс производства","fr":"Processus de fabrication","ja":"製造プロセス","ko":"제조 공정","es":"Proceso de fabricación"},
"mold_flow_title":{"zh":"医疗器械模具怎么造","en":"How Medical Molds Are Made","de":"Wie medizinische Formen entstehen","ru":"Как изготавливаются медицинские пресс-формы","fr":"Comment sont fabriqués les moules médicaux","ja":"医療用金型はどう造られるか","ko":"의료용 금형은 어떻게 제작되나","es":"Cómo se fabrican los moldes médicos"},
"mold_flow_sub":{"zh":"从设计到验证量产的全链路","en":"The full chain from design to validated mass production","de":"Die komplette Kette von der Konstruktion bis zur validierten Serie","ru":"Полный цикл от проектирования до валидированного серийного производства","fr":"Toute la chaîne, de la conception à la production en série validée","ja":"設計から検証済み量産までの全工程","ko":"설계부터 검증된 양산까지 전 과정","es":"Toda la cadena, del diseño a la producción en serie validada"},
"mold_qa_kicker":{"zh":"质量体系","en":"Quality System","de":"Qualitätssystem","ru":"Система качества","fr":"Système qualité","ja":"品質システム","ko":"품질 시스템","es":"Sistema de calidad"},
"mold_qa_title":{"zh":"医疗模具质量怎么控","en":"How Medical Mold Quality Is Controlled","de":"Wie die Qualität medizinischer Formen gesichert wird","ru":"Как контролируется качество медицинских пресс-форм","fr":"Comment la qualité des moules médicaux est maîtrisée","ja":"医療用金型の品質管理","ko":"의료용 금형 품질 관리 방법","es":"Cómo se controla la calidad de los moldes médicos"},
"mold_qa_sub":{"zh":"合规且可追溯","en":"Compliant and fully traceable","de":"Konform und vollständig rückverfolgbar","ru":"Соответствие требованиям и полная прослеживаемость","fr":"Conforme et entièrement traçable","ja":"適合性と完全なトレーサビリティ","ko":"규정 준수 및 완전 추적 가능","es":"Conforme y totalmente trazable"},
"cert_13485_t":{"zh":"ISO 13485","en":"ISO 13485","de":"ISO 13485","ru":"ISO 13485","fr":"ISO 13485","ja":"ISO 13485","ko":"ISO 13485","es":"ISO 13485"},
"cert_13485_e":{"zh":"医疗器械质量管理体系","en":"Medical Device QMS","de":"QMS für Medizinprodukte","ru":"СМК для медицинских изделий","fr":"SMQ dispositifs médicaux","ja":"医療機器QMS","ko":"의료기기 QMS","es":"SGC de dispositivos médicos"},
"cert_iatf_t":{"zh":"IATF 16949","en":"IATF 16949","de":"IATF 16949","ru":"IATF 16949","fr":"IATF 16949","ja":"IATF 16949","ko":"IATF 16949","es":"IATF 16949"},
"cert_iatf_e":{"zh":"汽车行业质量管理体系","en":"Automotive QMS","de":"QMS für die Automobilindustrie","ru":"СМК для автопрома","fr":"SMQ automobile","ja":"自動車QMS","ko":"자동차 QMS","es":"SGC automotriz"},
"cert_9001_t":{"zh":"ISO 9001","en":"ISO 9001","de":"ISO 9001","ru":"ISO 9001","fr":"ISO 9001","ja":"ISO 9001","ko":"ISO 9001","es":"ISO 9001"},
"cert_9001_e":{"zh":"质量管理体系","en":"Quality Management","de":"Qualitätsmanagement","ru":"Менеджмент качества","fr":"Management de la qualité","ja":"品質マネジメント","ko":"품질 경영","es":"Gestión de la calidad"},
...
"prod_pp_title":{"zh":"注塑产品","en":"Injection Molded Products","de":"Spritzgussprodukte","ru":"Литьевые изделия","fr":"Produits injectés","ja":"射出成形製品","ko":"사출 성형 제품","es":"Productos de inyección"},
  ...
  "ft_prod_industries":{"zh":"应用领域","en":"Application Areas","de":"Anwendungsbereiche","ru":"Области применения","fr":"Domaines d'application","ja":"応用分野","ko":"응용 분야","es":"Áreas de aplicación"},
...
"hnav_brand":{"zh":"HONDVO","en":"HONDVO","ja":"HONDVO","ko":"HONDVO","de":"HONDVO","fr":"HONDVO","es":"HONDVO","ru":"HONDVO"},
  ...
  "hnav_prod_browse_items":{"zh":["输液与给药系统","体外诊断与采样（IVD）","呼吸系统","食品/医疗包装 & 母婴类产品"],"en":["Infusion and Drug Delivery Systems","In Vitro Diagnostics & Sampling (IVD)","Respiratory Systems","Food / Medical Packaging & Baby & Maternal Products"],"de":["Infusions- und Arzneimittelabgabesysteme","In-vitro-Diagnostik & Probenahme (IVD)","Atemwegssysteme","Lebensmittel-/Medizinverpackung & Baby- und Mutterprodukte"],"ru":["Системы инфузии и доставки лекарств","Инвитро-диагностика и взятие проб (IVD)","Дыхательные системы","Упаковка для пищевой/медицинской продукции и товары для мам и малышей"],"fr":["Systèmes de perfusion et d'administration de médicaments","Diagnostic in vitro & prélèvement (IVD)","Systèmes respiratoires","Emballage alimentaire/médical & produits bébé et maternité"],"ja":["輸液・薬液投与システム","体外診断・検体採取（IVD）","呼吸器システム","食品・医療包装 & ベビー・マタニティ製品"],"ko":["수액 및 약물 전달 시스템","체외진단 및 검체 채취 (IVD)","호흡기 시스템","식품/의료 포장 & 유아·출산 용품"],"es":["Sistemas de infusión y administración de fármacos","Diagnóstico in vitro y toma de muestras (IVD)","Sistemas respiratorios","Envases alimentarios/médicos y productos para bebés y maternidad"]},
  ...
  "hnav_prod_industries":{"zh":"应用领域","en":"Application Areas","ja":"応用分野","ko":"응용 분야","de":"Anwendungsbereiche","fr":"Domaines d'application","es":"Áreas de aplicación","ru":"Области применения"},
...
const LEGAL = {
  ...
  privacy: {
    ...
    s4_t: { zh:"Cookie、本地存储与统计分析", en:"Cookies, Local Storage & Analytics", de:"Cookies, lokaler Speicher & Analyse", ru:"Файлы cookie, локальное хранилище и аналитика", fr:"Cookies, stockage local et analyse", ja:"Cookie・ローカルストレージ・アクセス解析", ko:"쿠키·로컬 저장소·통계 분석", es:"Cookies, almacenamiento local y análisis" },

    s4_b: { zh:"本站使用 Cookie 与本地存储以改进服务。具体说明：① 在您的浏览器中生成并保存匿名访客标识 hondvo_vid（随机字符串，不含姓名、电话等个人身份信息）；② 采集页面浏览数据（页面路径、停留时长、来源页、设备类型）与站内搜索关键词；③ 上述数据用于统计访问情况、改进网站内容与服务质量，保存期限不超过 12 个月；④ 同时使用必要的本地存储（如 sessionStorage）记住您的语言偏好。您可随时通过「Cookie 设置」拒绝行为追踪，拒绝后仅保留实现基本功能所必需的本地存储，您主动提交的询盘信息不受影响。我们可能按站点配置启用第三方统计分析服务（如 Google Analytics 4、百度统计），其数据处理遵循相应服务商的隐私政策。", en:"This site uses cookies and local storage to improve our service. Specifically: (1) an anonymous visitor identifier 'hondvo_vid' (a random string containing no personal identifiers such as name or phone number) is generated and stored in your browser; (2) we collect page-view data (page path, dwell time, referrer, device type) and on-site search keywords; (3) this data is used to measure traffic and improve our website and service quality, and is retained for no longer than 12 months; (4) necessary local storage (such as sessionStorage) is also used to remember your language preference. You may decline behavioural tracking at any time via 'Cookie Settings'; if declined, only the local storage strictly required for basic functionality is kept, and inquiries you submit yourself are unaffected. Depending on site configuration, third-party analytics services (e.g. Google Analytics 4, Baidu Analytics) may be enabled, and their data processing follows the respective providers' privacy policies.", de:"Diese Website verwendet Cookies und lokalen Speicher, um unseren Service zu verbessern. Im Einzelnen: (1) In Ihrem Browser wird eine anonyme Besucherkennung 'hondvo_vid' erzeugt und gespeichert (eine Zufallszeichenfolge ohne personenbezogene Angaben wie Name oder Telefonnummer); (2) wir erfassen Seitenaufrufe (Pfad, Verweildauer, Verweisquelle, Gerätetyp) und Suchbegriffe innerhalb der Website; (3) diese Daten dienen der Zugriffsmessung sowie der Verbesserung unserer Website und Servicequalität und werden höchstens 12 Monate gespeichert; (4) zusätzlich wird notwendiger lokaler Speicher (z. B. sessionStorage) genutzt, um Ihre Sprachpräferenz zu speichern. Sie können das Verhaltens-Tracking jederzeit über 'Cookie-Einstellungen' ablehnen; bei Ablehnung wird nur der für Grundfunktionen erforderliche lokale Speicher beibehalten, selbst übermittelte Anfragen bleiben unberührt. Je nach Konfiguration können Analyse-Dienste Dritter (z. B. Google Analytics 4, Baidu Analytics) aktiviert sein; deren Datenverarbeitung richtet sich nach den Datenschutzbestimmungen der jeweiligen Anbieter.", ru:"Этот сайт использует файлы cookie и локальное хранилище для улучшения сервиса. Подробнее: (1) в вашем браузере создаётся и сохраняется анонимный идентификатор посетителя 'hondvo_vid' (случайная строка, не содержащая персональных данных, таких как имя или телефон); (2) мы собираем данные о просмотрах страниц (путь, время на странице, источник перехода, тип устройства) и поисковые запросы на сайте; (3) эти данные используются для оценки посещаемости и улучшения сайта и качества услуг и хранятся не более 12 месяцев; (4) также используется необходимое локальное хранилище (например, sessionStorage) для запоминания языковых предпочтений. Вы можете в любой момент отказаться от поведенческого отслеживания через «Настройки cookie»; при отказе сохраняется только локальное хранилище, необходимое для базовых функций, а отправленные вами запросы остаются без изменений. В зависимости от конфигурации могут быть включены сторонние сервисы аналитики (например, Google Analytics 4, Baidu Analytics); обработка данных регулируется политикой конфиденциальности соответствующих поставщиков.", fr:"Ce site utilise des cookies et le stockage local pour améliorer notre service. En détail : (1) un identifiant de visiteur anonyme « hondvo_vid » (chaîne aléatoire ne contenant aucune donnée personnelle telle que nom ou téléphone) est généré et conservé dans votre navigateur ; (2) nous collectons des données de consultation (chemin de page, durée, source de provenance, type d'appareil) et les mots-clés de recherche sur le site ; (3) ces données servent à mesurer l'audience et à améliorer notre site et la qualité de service, et sont conservées au maximum 12 mois ; (4) un stockage local nécessaire (comme sessionStorage) est également utilisé pour mémoriser votre préférence de langue. Vous pouvez refuser le suivi comportemental à tout moment via « Paramètres des cookies » ; en cas de refus, seul le stockage local strictement nécessaire au fonctionnement de base est conservé, et les demandes que vous soumettez vous-même ne sont pas affectées. Selon la configuration du site, des services d'analyse tiers (par ex. Google Analytics 4, Baidu Analytics) peuvent être activés ; leur traitement des données suit la politique de confidentialité de ces fournisseurs.", ja:"本サイトはサービス向上のため Cookie およびローカルストレージを使用しています。具体的には、① お客様のブラウザ内に匿名の訪問者識別子「hondvo_vid」（氏名・電話番号などの個人情報を含まないランダムな文字列）を生成・保存します。② ページ閲覧データ（ページパス、滞在時間、参照元、デバイス種別）およびサイト内検索キーワードを収集します。③ これらのデータはアクセス状況の把握とサイト・サービス品質の改善に利用し、保存期間は最長 12 か月です。④ 併せて、言語設定を記憶するために必要なローカルストレージ（sessionStorage など）を使用します。お客様は「Cookie 設定」からいつでも行動追跡を拒否できます。拒否した場合は基本機能に必要なローカルストレージのみが保持され、お客様が自ら送信したお問い合わせには影響しません。サイト設定により、第三者の解析サービス（Google Analytics 4、百度統計など）を有効にする場合があり、そのデータ処理は各提供者のプライバシーポリシーに従います。", ko:"본 웹사이트는 서비스 개선을 위해 쿠키와 로컬 저장소를 사용합니다. 구체적으로: ① 브라우저에 익명 방문자 식별자 'hondvo_vid'(이름·전화번호 등 개인 식별 정보를 포함하지 않는 임의 문자열)를 생성·저장합니다. ② 페이지 조회 데이터(페이지 경로, 체류 시간, 유입 경로, 기기 유형)와 사이트 내 검색 키워드를 수집합니다. ③ 이 데이터는 접속 현황 파악과 웹사이트·서비스 품질 개선에 사용되며 보관 기간은 최대 12개월입니다. ④ 또한 언어 설정을 기억하기 위해 필요한 로컬 저장소(sessionStorage 등)를 사용합니다. 이용자는 '쿠키 설정'에서 언제든지 행동 추적을 거부할 수 있으며, 거부 시 기본 기능에 필요한 로컬 저장소만 유지되고 이용자가 직접 제출한 문의에는 영향이 없습니다. 사이트 설정에 따라 제3자 분석 서비스(예: Google Analytics 4, Baidu Analytics)가 활성화될 수 있으며, 해당 데이터 처리는 각 제공자의 개인정보 처리방침을 따릅니다.", es:"Este sitio web utiliza cookies y almacenamiento local para mejorar nuestro servicio. En concreto: (1) se genera y guarda en su navegador un identificador anónimo de visitante «hondvo_vid» (una cadena aleatoria que no contiene datos personales como nombre o teléfono); (2) recopilamos datos de navegación (ruta de la página, tiempo de permanencia, procedencia, tipo de dispositivo) y palabras clave de búsqueda en el sitio; (3) estos datos se utilizan para medir el tráfico y mejorar nuestro sitio web y la calidad del servicio, y se conservan como máximo 12 meses; (4) también se utiliza almacenamiento local necesario (como sessionStorage) para recordar su preferencia de idioma. Puede rechazar el seguimiento de comportamiento en cualquier momento mediante «Configuración de cookies»; si lo rechaza, solo se conserva el almacenamiento local estrictamente necesario para funciones básicas, y las consultas que usted envíe no se ven afectadas. Según la configuración del sitio, pueden habilitarse servicios de análisis de terceros (p. ej. Google Analytics 4, Baidu Analytics), cuyo tratamiento de datos se rige por las políticas de privacidad de dichos proveedores." },
